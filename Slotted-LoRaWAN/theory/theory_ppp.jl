...
SHADOWING_STD_DB = 8.0   # Prop.jlのパラメータと合わせる
...
for sync_rate in SYNC_RATES
    ...
    for N in N_RANGE
        ...
        SLOT_LENGTH_SEC = 0.100 # 200ms (Matches Prop.jl slots)
        ...
        # Current formula used in theory.jl and older versions.
        ...
        # C. Attempt PER (Collision-only for that specific transmission)
        # Prob(Success | Sent)
